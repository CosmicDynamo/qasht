define([
    ...
    "dojo/window", "../runner", "blocks/genId", "dojo/text!qasht/browser/template/testGroup.html",
...
], function (lang, domConstruct, domClass, domStyle, query, dom, win, runner, genId, testGroup, testTemplate, testLog, logStart, logMessage, logEnd) {
    var render = {
        testGroup: testGroup,
